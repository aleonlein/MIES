...
static Function PerformMiesTasks(outputFilePath)
	...
	ASSERT(!FileExists(outputFilePath), "Output file must not exist")
	...
	print "Free Memory: %g GB\r", GetFreeMemory()
...
static Function/S FindNextExperiment(prefs)
	...
	WAVE/Z/T inputFiles = JSON_GetTextWave(jsonID, "inputFiles")
	index = JSON_GetVariable(jsonID, "/index")
